...
if (isset($_SESSION['ROL'])) {
    switch ($_SESSION['ROL']) {
        case 'ADMIN':
            ...
            break;
        case 'EMPLEADO':
            header("Location:indexEmployees.php");
            break;
        case 'CLIENTE':
        ...
        <div class="box-login">
            ...
            <div class="box">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="login-box input">
                        <input type="submit" href="#" onclick="alerta_error_iniciar_sesion()" value="Ingresar">
                    </div>

                    <div class="login-box input">
                        <h5 class="h5">Olvidaste tu contraseña?</h5> <a class="a" href="forgotPassword.php">Haz click
                            aqui</a><br><br>
                        <h5 class="h5">No tienes una cuenta?</h5> <a class="a" href="register.php">Registrate</a>
                    </div>
                </form>
            </div>
        </div>
